...
module.exports = {
    ...
    SESSION: process.env.KALIPPAN_CODE === undefined ? '' : process.env.KALIPPAN_CODE,
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By KALIPPAN_SER' : process.env.ALL_CAPTION,
    ...
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒ ⋈ ᴋᴀʟɪᴘᴘᴀɴ sᴇʀ ⋈ ‒‒‒⊣' : process.env.BOT_NAME,
    ...
    ALLEMOJI: process.env.CMD_LIST === undefined ? '/💙/🌟/🥀/🐾' : process.env.CMD_LIST,
